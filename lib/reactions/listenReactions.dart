...
vacantSpaces=[totalLength*0.16,totalLength*0.24, totalLength*0.32, totalLength*0.40];
}
...
void initialiseRecord(){
    playersId.forEach((element) { 
      reactionRecord.update('$element reaction', (value) => '',ifAbsent: () => null,);
    });
...
Image reactionImage(int index){
  return Image(image: AssetImage(reactions[index]),);
}
