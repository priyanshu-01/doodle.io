...
super.initState();
  ...
  Future<void> updateScore() async{
    ...
    Firestore.instance.collection('rooms').document(documentid).updateData({
      'tempScore':tempScore,
  ...
  return ListView.builder(
                      ...
                      // ),
                                     ...
                                     child: Column(
                                       children: [
                                         nameOfOthers(i,n),
                                         Text('$m', style: GoogleFonts.ubuntu(fontSize: 10.0)),
                                       ],
                                     ),
                                        )),
                                  ):
...
Widget nameOfOthers(String iden, String nam){
  ...
  return Text('$nam', style: GoogleFonts.roboto(color: Colors.black, fontSize: 12.0));
